...
/**
 * Criteria class for the {@link wf.transotas.domain.Caso} entity. This class is used
 * in {@link wf.transotas.web.rest.CasoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /casos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CasoCriteria implements Serializable, Criteria {
    ...
    public CasoCriteria(CasoCriteria other) {
    ...
    @Override
    public CasoCriteria copy() {
        return new CasoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CasoCriteria that = (CasoCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, extra1, extra2, extra3, extra4, extra5, extra6, extra7, extra8, extra9, extra10, distinct);
    }
