...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CASOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CASO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CASO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CASO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CASO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CASO actions', async () => {
      const expectedActions = [
        {
