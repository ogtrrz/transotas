...
export const ComentariosDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="transotasApp.comentarios.delete.question">
        <Translate contentKey="transotasApp.comentarios.delete.question" interpolate={{ id: comentariosEntity.id }}>
          Are you sure you want to delete this Comentarios?
        </Translate>
      </ModalBody>
      <ModalFooter>
